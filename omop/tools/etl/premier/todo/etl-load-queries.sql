...
-- create load_id
insert into cdh_premier_omop_etl.load_info(  load_name, load_description, status )
values ('premier1_v2', 'first premier_v2 etl load', 0);

-- COMMAND ----------

select * from cdh_premier_omop_etl.load_info;
...
-- load provider
INSERT INTO cdh_premier_omop_etl.stage_provider
(
