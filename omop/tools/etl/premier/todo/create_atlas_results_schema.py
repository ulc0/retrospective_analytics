...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort
USING DELTA
AS
SELECT
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_censor_stats ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_censor_stats 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS cohort_definition_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_inclusion ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_inclusion 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS cohort_definition_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_inclusion_result ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_inclusion_result 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS cohort_definition_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_inclusion_stats ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_inclusion_stats 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS cohort_definition_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_summary_stats ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_summary_stats 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS cohort_definition_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_cache  ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_cache  
USING DELTA
AS
SELECT
CAST(NULL AS int) AS design_hash,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_censor_stats_cache  ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_censor_stats_cache  
USING DELTA
AS
SELECT
CAST(NULL AS int) AS design_hash,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_inclusion_result_cache;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_inclusion_result_cache  
USING DELTA
AS
SELECT
CAST(NULL AS int) AS design_hash,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_inclusion_stats_cache  ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_inclusion_stats_cache  
USING DELTA
AS
SELECT
CAST(NULL AS int) AS design_hash,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_summary_stats_cache  ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_summary_stats_cache  
USING DELTA
AS
SELECT
CAST(NULL AS int) AS design_hash,
...
drop TABLE IF  EXISTS results_catalog.results_schema.feas_study_inclusion_stats ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.feas_study_inclusion_stats 
USING DELTA
AS
SELECT
...
drop TABLE IF  EXISTS results_catalog.results_schema.feas_study_index_stats ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.feas_study_index_stats 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS study_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.feas_study_result ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.feas_study_result 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS study_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.heracles_analysis;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.heracles_analysis
USING DELTA
AS
SELECT
...
drop TABLE IF  EXISTS results_catalog.results_schema.HERACLES_HEEL_results ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.HERACLES_HEEL_results 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS cohort_definition_id,
...
drop TABLE IF EXISTS results_catalog.results_schema.heracles_results;
--HINT PARTITION(cohort_definition_id int)
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.heracles_results
USING DELTA
AS
SELECT
CAST(NULL AS int) AS cohort_definition_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.heracles_results_dist;
--HINT PARTITION(cohort_definition_id int)
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.heracles_results_dist
USING DELTA
AS
SELECT
CAST(NULL AS int) AS cohort_definition_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.heracles_periods;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.heracles_periods
USING DELTA
AS
SELECT
...
drop TABLE IF  EXISTS results_catalog.results_schema.cohort_sample_element ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cohort_sample_element 
USING DELTA
AS
SELECT
...
drop TABLE IF  EXISTS results_catalog.results_schema.ir_analysis_dist  ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.ir_analysis_dist  
USING DELTA
AS
SELECT
CAST(NULL AS int) AS analysis_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.ir_analysis_result ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.ir_analysis_result 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS analysis_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.ir_analysis_strata_stats ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.ir_analysis_strata_stats 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS analysis_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.ir_strata ;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.ir_strata 
USING DELTA
AS
SELECT
CAST(NULL AS int) AS analysis_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.cc_results;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.cc_results
USING DELTA
AS
SELECT
...
drop TABLE IF  EXISTS results_catalog.results_schema.pathway_analysis_codes;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.pathway_analysis_codes
USING DELTA
AS
SELECT
...
drop TABLE IF  EXISTS results_catalog.results_schema.pathway_analysis_events;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.pathway_analysis_events
USING DELTA
AS
SELECT
CAST(NULL AS bigint) AS pathway_analysis_generation_id,
...
drop TABLE IF EXISTS results_catalog.results_schema.pathway_analysis_paths;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.pathway_analysis_paths
USING DELTA
AS
SELECT
CAST(NULL AS bigint) AS pathway_analysis_generation_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.pathway_analysis_stats;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.pathway_analysis_stats
USING DELTA
AS
SELECT
CAST(NULL AS bigint) AS pathway_analysis_generation_id,
...
drop TABLE IF  EXISTS results_catalog.results_schema.concept_hierarchy;
CREATE TABLE IF NOT EXISTS results_catalog.results_schema.concept_hierarchy
USING DELTA
AS
SELECT
...
TRUNCATE TABLE results_catalog.results_schema.concept_hierarchy;

INSERT INTO results_catalog.results_schema.concept_hierarchy
...
FROM (
 ...
 concept_id,
 concept_name
 FROM results_catalog.cdh_abfm_omop_lds.concept
...
LEFT JOIN (
 ...
 FROM results_catalog.cdh_abfm_omop_lds.concept c1
 INNER JOIN results_catalog.cdh_abfm_omop_lds.concept_ancestor ca1 ON c1.concept_id = ca1.descendant_concept_id
 AND c1.domain_id = 'Condition'
 AND ca1.min_levels_of_separation = 1
 INNER JOIN results_catalog.cdh_abfm_omop_lds.concept c2 ON ca1.ancestor_concept_id = c2.concept_id
...
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept soc ON hlgt_to_soc.soc_concept_id = soc.concept_id;
...
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept atc1 ON atc3_to_atc1.atc1_concept_id = atc1.concept_id;
...
FROM (
 ...
 c2.concept_id AS rxnorm_ingredient_concept_id,
 c2.concept_name AS RxNorm_ingredient_concept_name
 FROM results_catalog.cdh_abfm_omop_lds.concept c2
...
FROM (
 ...
 concept_id,
 concept_name
 FROM results_catalog.cdh_abfm_omop_lds.concept c
 WHERE domain_id = 'Measurement'
) m
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept_ancestor ca1 ON M.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept c3 ON ca3.ANCESTOR_CONCEPT_ID = c3.concept_id
...
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept_ancestor ca1 ON obs.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN results_catalog.cdh_abfm_omop_lds.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
...
(
 ...
 FROM results_catalog.cdh_abfm_omop_lds.concept c1
 INNER JOIN results_catalog.cdh_abfm_omop_lds.vocabulary v1 ON c1.vocabulary_id = v1.vocabulary_id
...
LEFT JOIN (
 ...
 FROM results_catalog.cdh_abfm_omop_lds.concept_ancestor ca0
 INNER JOIN (
 SELECT DISTINCT c2.concept_id AS os3_concept_id
 FROM results_catalog.cdh_abfm_omop_lds.concept_ancestor ca1
 INNER JOIN results_catalog.cdh_abfm_omop_lds.concept c1 ON ca1.DESCENDANT_CONCEPT_ID = c1.concept_id
 INNER JOIN results_catalog.cdh_abfm_omop_lds.concept_ancestor ca2 ON c1.concept_id = ca2.ANCESTOR_CONCEPT_ID
 INNER JOIN results_catalog.cdh_abfm_omop_lds.concept c2 ON ca2.DESCENDANT_CONCEPT_ID = c2.concept_id
...
TRUNCATE TABLE results_catalog.results_schema.heracles_analysis;

insert into results_catalog.results_schema.heracles_analysis
...
CREATE TABLE results_catalog.results_schema.cvmvwm6ydigits
USING DELTA
AS
SELECT
digits.n 
...
CREATE TABLE results_catalog.results_schema.cvmvwm6ygenerate_dates
USING DELTA
AS
SELECT
y1.n + (10*y10.n) + (100*y100.n) + (1000*y1000.n) AS d_years,
 mths.n as d_months
FROM
results_catalog.results_schema.cvmvwm6ydigits y1,
results_catalog.results_schema.cvmvwm6ydigits y10,
...
CREATE TABLE results_catalog.results_schema.cvmvwm6yyearly_dates
USING DELTA
AS
SELECT
to_date(cast(d_years as string) || '-' || cast(d_months as string) || '-' || cast(01 as string)) as generated_date
FROM
results_catalog.results_schema.cvmvwm6ygenerate_dates
where d_months = 1
;

CREATE TABLE results_catalog.results_schema.cvmvwm6ymonthly_dates
USING DELTA
AS
SELECT
to_date(cast(d_years as string) || '-' || cast(d_months as string) || '-' || cast(01 as string)) as generated_date
...
CREATE TABLE results_catalog.results_schema.cvmvwm6yweekly_dates
USING DELTA
AS
SELECT
...
(
 ...
 from results_catalog.results_schema.cvmvwm6ydigits d1, results_catalog.results_schema.cvmvwm6ydigits d10, results_catalog.results_schema.cvmvwm6ydigits d100, results_catalog.results_schema.cvmvwm6ydigits d1000
) seq;

CREATE TABLE results_catalog.results_schema.cvmvwm6yquarterly_dates
USING DELTA
AS
SELECT
...
CREATE TABLE results_catalog.results_schema.cvmvwm6ytemp_period
USING DELTA
AS
SELECT
*
...
from results_catalog.results_schema.cvmvwm6ymonthly_dates md
UNION ALL
...
from results_catalog.results_schema.cvmvwm6yweekly_dates wd
...
from results_catalog.results_schema.cvmvwm6yquarterly_dates qd
UNION ALL
...
from results_catalog.results_schema.cvmvwm6yyearly_dates yd
-- ADD UNION ALLs for additional period definitions
) monthlyDates;

TRUNCATE TABLE results_catalog.results_schema.heracles_periods;

INSERT INTO results_catalog.results_schema.heracles_periods (period_id, period_name, period_order, period_type, period_start_date, period_end_date)
...
from results_catalog.results_schema.cvmvwm6ytemp_period;

truncate table results_catalog.results_schema.cvmvwm6ydigits;

drop table results_catalog.results_schema.cvmvwm6ydigits;

truncate table results_catalog.results_schema.cvmvwm6ygenerate_dates;

drop table results_catalog.results_schema.cvmvwm6ygenerate_dates;

truncate table results_catalog.results_schema.cvmvwm6yyearly_dates;

drop table results_catalog.results_schema.cvmvwm6yyearly_dates;

truncate table results_catalog.results_schema.cvmvwm6yquarterly_dates;

drop table results_catalog.results_schema.cvmvwm6yquarterly_dates;

truncate table results_catalog.results_schema.cvmvwm6ymonthly_dates;

drop table results_catalog.results_schema.cvmvwm6ymonthly_dates;

truncate table results_catalog.results_schema.cvmvwm6yweekly_dates;

drop table results_catalog.results_schema.cvmvwm6yweekly_dates;

TRUNCATE TABLE results_catalog.results_schema.cvmvwm6ytemp_period;

DROP TABLE results_catalog.results_schema.cvmvwm6ytemp_period;
