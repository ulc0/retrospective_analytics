...
# MAGIC )
# MAGIC SELECT
# MAGIC     d.lab_test_code_type  AS measurement_source_type, -- LOINC, null, or nonstandard
# MAGIC     d.lab_test_code AS measurement_source_value,
# MAGIC     '44818702' AS measurement_source_type_value,
# MAGIC     d.collection_datetime AS measurement_date,
...
# MAGIC     1 AS load_id,
# MAGIC     0 AS loaded
# MAGIC FROM ${source_catalog}.${source_schema}.genlab d
