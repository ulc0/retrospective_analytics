...
cci_demos = spark.table("cdh_hv_race_ethnicity_covid_exploratory.rvn4_pmca_demos")
...
#     plt.yscale("log")
    plt.suptitle(f'PMCA Score Distribution (over demo={demo_col.upper()})', y=0.98)
...
for demo in ["sex", "age_group", "region", "race", "ethnicity"]:
    ...
    plot_ridgeline(pdf, score_col="pmca_score", demo_col=demo)
