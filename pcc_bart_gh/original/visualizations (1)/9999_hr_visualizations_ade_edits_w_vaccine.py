...
def generate_pdf(is_adult=True, is_inpatient=True):
    table_name = f"cdh_hv_race_ethnicity_covid_exploratory.sve5_coxph_vaccine_{'adult' if is_adult else 'pediatric'}_{'inpatient' if is_inpatient else 'outpatient'}_221003"
    pdf = (
