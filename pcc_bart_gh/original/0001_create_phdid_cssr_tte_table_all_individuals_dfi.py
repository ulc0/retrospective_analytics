...
# this exists but name is different name icd10cm_diagnosis_codes_to_ccsr_categories_map
# ccsr_lookup = spark.table("cdh_reference_data.ccsr_codelist")
ccsr_lookup = spark.table("icd10cm_diagnosis_codes_to_cssr_categories_map")
