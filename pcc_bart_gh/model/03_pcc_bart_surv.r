...
dat = SparkR::sql("SELECT tte_ccsr, age, covid_patient, gender, p3_ccsr_first from bart_pcc.end005_full")

# COMMAND ----------

end005 = as.data.frame(dat)
...
post = mc.surv.bart(x.train=x.train, times=time, delta=delta, mc.cores=8)
