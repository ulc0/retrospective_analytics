...
exl4.write.mode("overwrite").format("delta").saveAsTable("bart_pcc.03_enrollment_exclusion")
exl4 = spark.table("bart_pcc.03_enrollment_exclusion")
...
coh.write.mode("overwrite").format("delta").saveAsTable("bart_pcc.04_exclusion_noncov_cov")
...
coh_tte.write.mode("overwrite").format("delta").saveAsTable("bart_pcc.05_ccsrs_tte")
