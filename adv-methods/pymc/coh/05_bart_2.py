...
# MAGIC %r
# MAGIC dat = SparkR::sql("SELECT * from cdh_premier_exploratory.ml_bart_end005_ccsr_smp1")
...
test = spark.table("cdh_premier_exploratory.ml_end005_ccsr_smp2").sampleBy("p3_ccsr_first", fractions={0:0.5,1:0.5}, seed = 99)
test.count()
