...
assembler = VectorAssembler(inputCols = db.columns[2:], outputCol = "features_xgb" ) # there is a column 'word' called feature
...
model_db = db_transformed.select(["features_xgb","label"])
...
#https://docs.databricks.com/en/machine-learning/train-model/xgboost-spark.html
...
paramGrid = (
    ParamGridBuilder()
    .addGrid(classifier.max_depth, [5, 7, 10])        
    .build()
)
#paramGrid
