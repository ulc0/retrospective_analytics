...
dbutils.widgets.text("gboostTable","edav_dev_cdh.cdh_ml.mimic_tree_biobert")
gboostTable=dbutils.widgets.get("gboostTable")

# COMMAND ----------

dbutils.widgets.text('input_table' , defaultValue= "edav_dev_cdh.cdh_ml.note_silver_mimic_biobert_diseases_ner",label="Huggingface Hub Name")
input_table = dbutils.widgets.get("input_table")
print(input_table)

dbutils.widgets.text('model_suffix' , defaultValue= "biobert_diseases_ner",label="Huggingface Hub Name")
