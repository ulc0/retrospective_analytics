...
from pyspark.sql.functions import isnan, when, count, col, desc, asc, row_number, concat_ws, coalesce,to_timestamp,regexp_replace, to_date, date_format, concat, concat_ws
...
notes0 = (
    ...
    .withColumn("notes", concat_ws(",",col("notes"))) # transforming array to string separated by comma 
)
