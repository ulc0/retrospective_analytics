...
# MAGIC
# MAGIC To install an older version of MLflow you can use the commented command `install_version("mlflow", "1.x")` and the `install_mlflow()` command to ensure the appropriate MLflow packages are installed.
...
# install_version("mlflow", "1.x")
# install_mlflow() 

# COMMAND ----------

# MAGIC %md
# MAGIC You can run this notebook as is for MLflow 2.0 workflows, be advised that since this is not a pinned install, the latest version of MLflow 2.x client is installed. 
# MAGIC
# MAGIC
