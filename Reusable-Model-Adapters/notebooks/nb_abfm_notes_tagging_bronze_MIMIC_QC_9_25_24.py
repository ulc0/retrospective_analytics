...
sdf_union_3 = (
    ...
    .select("note_text",'encoding',"clean_text","wordCount","provider_id", "words", "note_id")
)
...
display(
    result_df_3
    .select('note_id','encoding','note_datetime','note_type','note_title','note_text','clean_text')    
)
