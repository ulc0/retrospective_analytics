...
#collections/collection_table.py
...
collections=f"{SRC_CATALOG}.{SRC_SCHEMA}"
tablesObj=spark.catalog.listTables(collections)
...
for t in tables:
    ...
    sqlstring=f"select {conceptcols} as concept_code, '{vocab}' as vocabulary_id,valueset as feature_name  from  {SRC_CATALOG}.{SRC_SCHEMA}.{t}"
    print(sqlstring)
