...
# MAGIC %md
# MAGIC valuesets=spark.table(f"{DBCATALOG}.{LAVASCHEMA}.code_local_valuesets").where(F.col("valueset_code").isin(valueset_code))#keep(['feature_name','concept_code'])
...
ft_name=f"{DBCATALOG}.{SCHEMA}.collections"
