...
print(f"Core Size: {core_size} TB, {core_size/total_size*100}%")
print(f"Complex Size: {cmp_size} TB, {cmp_size/total_size*100}%")
print(f"Total Size: {cmp_size+core_size} TB, {(cmp_size+core_size)/total_size*100}%")
print(f"Dimensions Size: {dim_size} TB, {dim_size/total_size*100}%")


# COMMAND ----------


patient_size=table_tb("facts_patient","cdh_premier_ra")
