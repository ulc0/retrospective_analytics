...
# MAGIC %md
# MAGIC # Backup legacy global init scripts and copy them to the current global init script framework
...
if __name__ == "__main__":
  ...
  try:
    if get_ipython().__class__.__name__ == 'ZMQInteractiveShell' or get_ipython().__class__.__name__ == 'DatabricksShell':
      ...
      dbutils.widgets.text("Scope Name", "")
      dbutils.widgets.text("Secret Name", "")
