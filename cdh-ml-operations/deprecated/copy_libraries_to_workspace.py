...
# MAGIC ls -ll  /Workspace/CDH/Configs/libraries
# MAGIC
...
# MAGIC cp ../packages/wheels/*.whl /Workspace/CDH/Configs/libraries/
# MAGIC ls -ll /Workspace/CDH/Configs/libraries/*.whl
