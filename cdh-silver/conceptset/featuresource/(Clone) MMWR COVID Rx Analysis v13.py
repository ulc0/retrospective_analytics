...
i=spark.sql("""select * from cdh_truveta.concept @v13 where conceptcode in ("1065667","1065692","260373001","720735008","10828004","52101004")""")

inv=spark.sql("""select * from cdh_truveta.concept @v13 where conceptcode in ("1065712","1065714","1065719","1065717")""")
display(i)
display(inv)
