...
newcols=['code','CONCEPT_TEXT','feature_name','FEATURE_DESC','Inpatient_Default','outpatient','rationale','version'
]
ccsr_lookup = spark.table(ccsr_table).toDF(*newcols).select('code','feature_name').withColumn('vocabulary_id',F.lit('ICD'))
