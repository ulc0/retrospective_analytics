...
dem=dem_wide.melt(['person_id'],concept_list,'vocabulary_id','code')
...
#demts_discharge=dem_wide.melt(['person_id','discharge_datetime',],ts_concept_list,'vocabulary_id','code').withColumnRenamed('discharge_datetime','visit_start_date')
...
#demts=dem_wide.melt(['person_id','admission_datetime'],ts_concept_list,'vocabulary_id','code').withColumnRenamed('admission_datetime','visit_start_date')
#display(demts)
