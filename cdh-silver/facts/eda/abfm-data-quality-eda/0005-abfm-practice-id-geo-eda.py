...
state_practice_counts['unique_practices'].quantile(1)

# COMMAND ----------

import plotly.express as px

vmax = state_practice_counts['unique_practices'].max()
vmax = 100
p25 = state_practice_counts['unique_practices'].quantile(0.25)/vmax
p50 = state_practice_counts['unique_practices'].quantile(0.5)/vmax
p75 = state_practice_counts['unique_practices'].quantile(0.75)/vmax

fig = px.choropleth(
    state_practice_counts,
    locations='state_abbr',
    locationmode="USA-states",
    color='unique_practices',
    scope="usa",
    range_color=[0,vmax],
...
fig = go.Figure(data=go.Choropleth(
    locations=state_practice_counts['state_abbr'], # Spatial coordinates
    z = state_practice_counts['unique_practices'].astype(int), # Data to be color-coded
    locationmode = 'USA-states', # set of locations match entries in `locations`
#     colorscale = 'Reds',
    colorbar_title = "",
      color_continuous_scale=[
          [0,'rgb(0,0,0)'],
          [state_practice_counts['unique_practices'].quantile(0.25),'rgb(255,0,0)'],
          [state_practice_counts['unique_practices'].quantile(0.5),'rgb(0,255,0)'],
          [state_practice_counts['unique_practices'].quantile(0.75),'rgb(0,0,255)'],
          [state_practice_counts['unique_practices'].quantile(1),'rgb(255,255,255)']
      ]
))
