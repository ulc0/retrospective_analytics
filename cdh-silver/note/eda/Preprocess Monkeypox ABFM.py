...
notes={
  "visit_diagnosis_cleaned": {"diagnosiscode":"encounterdiagnosiscode",
                                  "diagnosistext":"encounterdiagnosistext",
                                   },
  "visit":                  {"diagnosiscode":"encountertypecode",
                                  "diagnosistext":"encountertypetext",
                                  },
  "pxSocHis":             {"diagnosiscode":"encounterdiagnosiscode",
                                  "diagnosistext":"encounterdiagnosistext"},
                                  }
...
vcriteria="""                    
                diagnosiscode like "B04" 
                or {diagnosiscode} like "359811007"
                or {diagnosiscode} like "359814004"
                or {diagnosiscode} like "59774002"
                or {diagnosiscode} like "1003839"
                or {diagnosiscode} like "1004340"
                or {diagnosiscode} like "05900"
                or {diagnosiscode} like "059%"                              
                or {diagnosiscode} like "414015000"  
                or {diagnosiscode} like "B0869"
                or {diagnosiscode} like "B0860"
                or {diagnosiscode} like "59010"
